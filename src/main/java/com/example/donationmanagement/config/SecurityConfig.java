    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, ClientRegistrationRepository clientRegistrationRepository) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/**", "/RiskAssessment/**","/risk/**","/api/risk-factors/history/**","/contracts/all","/RiskFactors/**","/contractAccounting/**","/campaigns/**","/digital-wallets/**","/donations/**","/rewards/**","/api/social-media/**","/wallet-transactions/**","/contractAccounting/**","/contractHolders/**","/api/mortality/**","/api/provisions/**","/api/reports/**","/sinistralite/**","/complaints/**","/notifications/**","/oauth2/**").permitAll()
